...
const i18n = {
  pt: {
    ...
    motivation1: 'O EyeWeb surgiu da necessidade de criar ferramentas automáticas e simplificadas para a proteção de dados online. O nosso propósito é democratizar o acesso à cibersegurança, prevenindo ataques através da utilização de agentes reativos inteligentes.',
    ...
    about: 'O EyeWeb é uma plataforma inovadora dedicada à análise e proteção de ativos digitais. O sistema permite identificar ameaças e vulnerabilidades de forma intuitiva, fornecendo informações detalhadas sempre que um dado pessoal ou credencial é identificado como comprometido.',
  ...
  en: {
    ...
    motivationIcon: 'fa-solid fa-lightbulb',
    motivation1: 'EyeWeb arose from the need to create automatic and simplified tools for online data protection. Our purpose is to democratize access to cybersecurity, preventing attacks through intelligent reactive agents.',
    ...
    aboutIcon: 'fa-solid fa-shield-halved',
    about: 'EyeWeb is an innovative platform dedicated to the analysis and protection of digital assets. The system intuitively identifies threats and vulnerabilities, providing detailed information whenever personal data or credentials are identified as compromised.',
